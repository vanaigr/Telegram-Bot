...
const t_messageType = makeDbType<"user" | "assistant" | "mark", "user" | "assistant" | "mark">("\"messageType\"")
const t_messageTypeNullable = makeDbType<"user" | "assistant" | "mark" | null, "user" | "assistant" | "mark" | null>("\"messageType\"")
const t_messageTypeArray = makeDbType<Array<"user" | "assistant" | "mark">, Array<"user" | "assistant" | "mark">>("\"messageType\"[]")
